<template>
    <div class="nov-slide" ref="slide">
        <div class="nov-slide-group" ref="slideGroup">
            <slot>
                <nov-slide-item
...
<script type="text/ecmascript-6">
    ...
    import NovSlideItem from './slide-item'

    const COMPONENT_NAME = 'nov-slide'
