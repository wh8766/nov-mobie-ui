...
<script>
    ...
    export default {
        ...
        mounted () {
            this.$overflowScrollingList = document.querySelectorAll('.weui-fix-safari-overflow-scrolling')
        },
        created () {
            if (this.value) {
                this.show = true
        ...
        computed: {
            currentTransition () {
                ...
                if (this.position === 'top') {
                    return 'weui-slide-from-top'
                }
                if (this.position === 'bottom') {
                    return 'weui-slide-from-bottom'
                }
                return 'weui-fade'
            },
            toastClass () {
                return {
                    ...
                    'weui-toast-top': this.position === 'top',
                    'weui-toast-bottom': this.position === 'bottom',
                    'weui-toast-middle': this.position === 'middle'
                }
            },
            style () {
...
<style lang="less">
    ...
    @import '../../common/style/widget/weui-tips/weui-mask.less';
    @import '../../common/style/icon/weui-icon_font.less';
    @import '../../common/style/widget/weui-tips/weui-toast.less';

    .weui-toast.weui-toast-top {
        top: 15px;
    }

    .weui-toast.weui-toast-bottom {
        top: auto;
        bottom: 15px;
        transform: translateX(-50%);
    }

    .weui-toast.weui-toast-middle {
        top: 50%;
        transform: translateX(-50%) translateY(-50%);
    }

    .weui-slide-from-top-enter, .weui-slide-from-top-leave-active {
        opacity: 0;
        transform: translateX(-50%) translateY(-100%) !important;
    }

    .weui-slide-from-bottom-enter, .weui-slide-from-bottom-leave-active {
        opacity: 0;
        transform: translateX(-50%) translateY(100%) !important;
    }

    .weui-slide-from-top-enter-active,
    .weui-slide-from-top-leave-active,
    .weui-slide-from-bottom-enter-active,
    .weui-slide-from-bottom-leave-active {
